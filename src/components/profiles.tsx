	...
	return (
		<>
			<Link
				...
				<Image
					className='rounded-md hover:scale-[1.05] duration-300 ease-out cursor-pointer'
					src={'/YB 3 Mukul.png'}
					width={1221 * profileScale}
